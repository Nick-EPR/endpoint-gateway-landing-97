...
const TotalCostComparison = () => {
  ...
  return (
    <div className="mb-12">
      ...
      {/* Desktop Table */}
      <div className="hidden lg:block bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700 rounded-lg overflow-hidden">
        {/* Table Header */}
      ...
      {/* Desktop Savings Callout */}
      <div className="hidden lg:block mt-6">
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 text-center">
          <p className="text-green-700 dark:text-green-400 font-medium">
            Save up to <span className="text-xl font-bold">$2,606</span> over 36 months with PCaaS — plus eliminate hidden IT costs and downtime
          </p>
        </div>
      </div>
    </div>
