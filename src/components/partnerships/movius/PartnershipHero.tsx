        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <div className="flex space-x-6 items-center mb-6">
              <img src="/lovable-uploads/451c6e0c-a782-43f8-99d3-0354cd584350.png" alt="Movius Logo" className="h-10" />
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-neutral-900 dark:text-white animate-fade-in">
              Modernize Your Communications with <span style={{ color: "#FF4E3B" }}>Movius</span> and{" "}
              <span style={{ color: "#93C852" }}>Lifetime EndPoint Resources</span>
            </h1>

            <p className="text-lg text-neutral-700 dark:text-neutral-300 animate-fade-in [animation-delay:200ms]">
              Transform your business communications with a secure, mobile-first solution that replaces legacy PBX
              systems and enhances customer engagement—all with expert implementation support.
            </p>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-xl animate-fade-in [animation-delay:300ms] border border-neutral-200 dark:border-neutral-800">
            <div className="aspect-video bg-neutral-100 dark:bg-neutral-800 flex items-center justify-center">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                ...
                <p className="text-xl font-semibold">Mobile-First Communications Platform</p>
                <p className="text-sm opacity-90">Integrated with T-Mobile's network for enterprise-grade security</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-xl font-semibold mb-4 text-neutral-900 dark:text-white">
                About Movius Secure Communications
              </h2>
              <p className="text-neutral-700 dark:text-neutral-300">
                Movius offers a comprehensive alternative to legacy PBX systems, focusing on secure voice/messaging and
                customer engagement. As a mobile-first platform, Movius seamlessly integrates enterprise-grade
                communications with T-Mobile's network, providing a robust solution for modern businesses.
              </p>
            </div>

            <div>
              <h2 className="text-xl font-semibold mb-4 text-neutral-900 dark:text-white">
                Lifetime EPR as Your Implementation Partner
              </h2>
              <p className="text-neutral-700 dark:text-neutral-300">
                Lifetime EndPoint Resources serves as your strategic implementation partner for Movius, bringing
                expertise in platform integration, asset management, security & compliance, and comprehensive support
                services to ensure a smooth transition and optimal performance.
              </p>
            </div>
          </div>
        </div>
