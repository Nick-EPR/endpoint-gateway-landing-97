      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="text-left hover:shadow-md transition-shadow border-primary/20 bg-white dark:bg-neutral-800">
            ...
            <Card className="text-left hover:shadow-md transition-shadow bg-white dark:bg-neutral-800">
              <CardContent className="pt-6">
                <div className="bg-primary/10 rounded-full h-12 w-12 flex items-center justify-center mb-4">
          ...
          <div className="mt-16 p-6 bg-neutral-50 dark:bg-neutral-800 rounded-lg border border-neutral-200 dark:border-neutral-700">
