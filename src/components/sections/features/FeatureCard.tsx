...
export const FeatureCard = memo(({
  ...
  return <div className={cn(baseCardStyles, lightCardStyles, darkCardStyles, className)} style={style}>
      {comingSoon}
      <div className={cn(iconContainerStyles, iconLightStyles, iconDarkStyles)}>
        {icon}
      </div>
      <h3 className="text-lg font-semibold mb-1.5 glass-text">
        {title}
      </h3>
      <p className="glass-text-subtle text-sm">
        {description}
      </p>
    </div>;
});
