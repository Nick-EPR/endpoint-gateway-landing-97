          ...
          <div className="flex justify-center mb-8 relative">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                <div className="relative">
                  <div className="absolute w-32 h-0.5 bg-primary/20 -left-16 rotate-45 origin-left animate-pulse" style={{ animationDelay: '0.2s' }}></div>
                  <div className="absolute w-32 h-0.5 bg-primary/20 -right-16 -rotate-45 origin-right animate-pulse" style={{ animationDelay: '0.4s' }}></div>
                </div>
              </div>
            </div>
          </div>
