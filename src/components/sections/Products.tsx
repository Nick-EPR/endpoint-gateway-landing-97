  ...
  return (
    <div className="relative">
      <div 
        ...
        } bg-white border border-neutral-100 hover:border-primary/30 animate-fade-up`}
        style={{
    ...
    <section id="solutions" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-neutral-800 animate-fade-up">
            The Lifetime EPR Platform
          </h2>
          <p className="text-lg text-neutral-600 animate-fade-up" style={{ animationDelay: '100ms' }}>
