        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-8 md:mb-16">
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <span className="text-xl md:text-2xl font-semibold text-foreground">+</span>
              <img src="/lovable-uploads/db5c2503-a1b3-49cc-a4d8-2e1cca8144e9.png" alt="T-Mobile" className="h-12 md:h-16 w-auto" />
            </div>
            <p className="text-base md:text-lg text-muted-foreground mb-8 animate-on-scroll px-4">
          ...
          <div className="max-w-6xl mx-auto mb-12">
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-semibold text-center text-foreground">Latest Updates & Guides</h3>
            </div>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="rounded-xl p-6 bg-card shadow-lg">
                <div className="flex items-center gap-3 mb-4">
                  <Zap className="w-5 h-5 text-[#E30074]" />
                  <h4 className="text-xl font-semibold text-card-foreground">Windows 11 Transition Guide</h4>
                </div>
              ...
              <div className="rounded-xl p-6 bg-card shadow-lg">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h4 className="text-xl font-semibold text-card-foreground">Healthcare Digital Transformation Guide</h4>
                </div>
                <p className="text-muted-foreground mb-6">
