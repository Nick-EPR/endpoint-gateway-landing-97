          ...
          <div className="max-w-6xl mx-auto mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="rounded-xl p-6 bg-white dark:bg-neutral-900/50 shadow-lg">
                ...
                <GuideImage src="/lovable-uploads/5f7f3800-f00c-4dc9-831d-dc17898e36d3.png" alt="Windows 11 Transition Guide" fileName="windows11-transition-guide.png" pages={[{
              ...
              <div className="rounded-xl p-6 bg-white dark:bg-neutral-900/50 shadow-lg">
                ...
                <GuideImage src="/lovable-uploads/ba322697-6a94-43af-a340-e3a4e4a5fdfd.png" alt="Healthcare Digital Transformation Guide" fileName="healthcare-transformation-guide.png" pages={[{
