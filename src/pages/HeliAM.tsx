...
const HeliAM = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900 relative">
      {/* Blue tech pattern background for entire page */}
      <div className="fixed inset-0 bg-gradient-to-br from-blue-50 to-white dark:from-blue-950/30 dark:to-neutral-900 -z-10"></div>
