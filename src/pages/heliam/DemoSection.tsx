...
const DemoSection = () => {
  ...
  return (
    <section className="py-20 bg-white dark:bg-neutral-900 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col lg:flex-row gap-12 items-center">
          <div className="lg:w-1/2 order-2 lg:order-1">
            {/* Demo image with frame */}
            <div className="relative">
              <div className="absolute inset-0 -m-4 rounded-xl bg-gradient-to-br from-primary/20 to-blue-500/20 blur-xl opacity-70 dark:from-primary/30 dark:to-blue-500/30"></div>
              <div className="relative rounded-xl overflow-hidden shadow-2xl border border-neutral-200/50 dark:border-neutral-700/50">
              ...
              {/* Floating badge */}
              <div className="absolute top-12 -right-4 bg-white dark:bg-neutral-800 shadow-lg p-3 rounded-lg rotate-3">
          ...
          <div className="lg:w-1/2 order-1 lg:order-2">
            <div className="max-w-lg">
              ...
              {/* Demo tabs */}
              <div className="flex gap-2 mb-8 p-1 bg-neutral-100 dark:bg-neutral-800 rounded-lg w-fit">
              ...
              <div className="flex gap-4">
                ...
                <Button variant="outline" size="lg" className="gap-2 dark:text-white">
